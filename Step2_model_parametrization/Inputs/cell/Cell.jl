...
function ocv_interpolant()
    ...
    SOC = 0:0.01:1
	Uocv = vec(readdlm("Step2_model_parametrization\\Inputs\\cell\\Uocv.csv",','))
...
function Ri_interpolants()
    ...
    R0_ch = readdlm("Step2_model_parametrization\\Inputs\\cell\\R0_ch.csv",',');
    R1_ch = readdlm("Step2_model_parametrization\\Inputs\\cell\\R1_ch.csv",',');
    C1_ch = readdlm("Step2_model_parametrization\\Inputs\\cell\\C1_ch.csv",',');
    R0_dch = readdlm("Step2_model_parametrization\\Inputs\\cell\\R0_dch.csv",',');
    R1_dch = readdlm("Step2_model_parametrization\\Inputs\\cell\\R1_dch.csv",',');
    C1_dch = readdlm("Step2_model_parametrization\\Inputs\\cell\\C1_dch.csv",',');
